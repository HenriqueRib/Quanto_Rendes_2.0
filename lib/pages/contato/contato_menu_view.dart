...
class ContatoMenuView extends StatefulWidget {
  const ContatoMenuView({Key? key}) : super(key: key);

  @override
  State<ContatoMenuView> createState() => _ContatoMenuViewState();
}

class _ContatoMenuViewState extends State<ContatoMenuView> {
  ...
  _getMenuLateral() {
    return _drawerController = KFDrawerController(
      initialPage: ClassBuilder.fromString('ContatoView'),
      items: [
        KFDrawerItem(
          text: const Text(
            "main",
